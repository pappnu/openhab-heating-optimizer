...
public class HeatingOptimizerActionHandler extends BaseModuleHandler<Action> implements ActionHandler {
    ...
    public @Nullable Map<String, @Nullable Object> execute(Map<String, Object> context) {
        logger.info("Starting heating optimization");
    ...
    private void optimize(HeatingOptimizerConfig conf, Item spotPricesItem, ZonedDateTime now, ZonedDateTime today,
        ...
        try {
            ...
            int heatingNeedDuringSecondPeriod;
            ...
            int maxHeatingGapDuringSecondPeriod;
            ...
            if (optimizationEnd.isAfter(tomorrow)) {
                ...
                heatingNeedDuringSecondPeriod = 0;
                maxHeatingGapDuringSecondPeriod = timeStepsInADay;
            }
            ...
            var result = optimizeHeatingWithLinearProgramming(prices, totalHeatingNeed, maxHeatingGapDuringFirstPeriod,
                    maxHeatingGapDuringSecondPeriod, minHeatingPeriod, firstGapSize, timeStepsInFirstPeriod,
                    heatingNeedDuringFirstPeriod, prevEndsInHeating, maxSolvingTime);
    ...
    protected static OptimizationResult optimizeHeatingWithLinearProgramming(double[] prices, int totalHeatingNeed,
            int maxHeatingGapDuringFirstPeriod, int maxHeatingGapDuringSecondPeriod, int minHeatingPeriod,
            int firstGapSize, int firstPeriodLength, int heatingNeedDuringFirstPeriod,
            boolean previousPeriodEndsInHeating, long solvingTimeLimit) {
        ...
        addMaxGapConstraint(0, Math.max(1, firstGapSize), solver, heatingStart);
